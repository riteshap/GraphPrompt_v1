...
class RequireLLM:
    def __init__(self, asp, exp_mode, shot_mode, llm_type, api_keys:dict):
        self.aspect = ["general", "rooms", "location", "service", "cleanliness", "building", "food"]
        self.asp = asp
        ...
        self.train_data = json.load(open("./dataset/space-train.json", "r", encoding="utf-8"))
        self.valid_data = json.load(open("./dataset/space-valid.json", "r", encoding="utf-8"))
    ...
    def get_llm_summary(self):
        ...
        save_path = ("./ablation_summary/space_{}_{}_{}.json"
